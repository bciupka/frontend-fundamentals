 ...
 */
function clearAll() {
    contentSection.querySelector('h1').textContent = 'Action Output';
    const children = contentSection.children;
    const childrenArray = Array.from(children);
    for (let i = 1; i < childrenArray.length; i++) {
        // console.log(childrenArray[i]);
        childrenArray[i].remove();
    };
    const headerE = document.createElement('h3');
    const paraE = document.createElement('p');
    contentSection.appendChild(headerE);
    contentSection.appendChild(paraE);
    return headerE;
}
/**
 * TODO:
...
function showMeme() {
    ...
    const headerE = clearAll();
    headerE.textContent = 'Meme:';
    const memeE = document.createElement('img');
    // const srcAttr = document.createAttribute('src');
    // const altAttr = document.createAttribute('alt');
    // srcAttr.value = randomMemeUrl;
    // altAttr.value = 'Meme';
    memeE.setAttribute('src', randomMemeUrl);
    memeE.setAttribute('alt', 'Meme');
    contentSection.appendChild(memeE);
}
...
function showJoke() {
    ...
    const headerE = clearAll();
    headerE.textContent = 'Joke:';
    const paraE = document.createElement('p');
    paraE.textContent = randomJokeText;
    contentSection.appendChild(paraE);
}
...
function showQuote() {
    ...
    contentSection.appendChild(quoteE);
    contentSection.appendChild(authorE);
}
...
function showRiddle() {
    ...
    const headerE = clearAll();
    headerE.textContent = 'Riddle:';
    const riddleE = document.createElement('p');
    riddleE.setAttribute('id', 'riddle')
    riddleE.textContent = randomRiddle.question;
    contentSection.appendChild(riddleE);
}
...
function revealAnswers() {
    const question = document.getElementById('riddle');
    if (!question) {
