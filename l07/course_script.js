 ...
 */
function clearAll() {
  const memeC = document.querySelector('.meme-content');
  const jokeC = document.querySelector('.joke-content');
  const quoteC = document.querySelector('.quote-content');
  const riddleC = document.querySelector('.riddle-content');
...
function showMeme() {
  ...
  const memeE = document.querySelector('.meme-content');
  const imgE = document.createElement('img');
  imgE.setAttribute('src', randomMemeUrl);
  clearAll();
  memeE.appendChild(imgE);
}
...
function showJoke() {
  ...
  const jokeE = document.createElement('p');
  jokeE.textContent = randomJokeText;
  clearAll();
  document.querySelector('.joke-content').appendChild(jokeE);
}
...
function showQuote() {
  ...
  quoteE.textContent = randomQuote.quote;
  authorE.textContent = '- ' + randomQuote.author;
  clearAll();
  document.querySelector('.quote-content').appendChild(quoteE);
  document.querySelector('.quote-content').appendChild(authorE);
}
...
function showRiddle() {
  ...
  const questionE = document.createElement('p');
  questionE.textContent = question;
  const answerE = document.createElement('p');
  answerE.setAttribute('id', 'riddle-answer');
  answerE.textContent = answer;
  answerE.hidden = true;
  clearAll();
  document.querySelector('.riddle-content').appendChild(questionE);
  document.querySelector('.riddle-content').appendChild(answerE);
}
...
function revealAnswers() {
  const riddleC = document.querySelector('.riddle-content');
  const riddle = riddleC.querySelector('p');
